...
eventdd log_totale donne over65 n_c n_d n_d_c n_ri N_t, fe timevar(time_to_treat) baseline(-1) cluster(comune) graph_op(title("EVENT STUDY DIFFERENCE IN DIFFERENCE", color(black) size(medium)) ytitle("N° PRESTAZIONI", size(small) ) yline(0, lcolor(black)) xlabel(-50 -40 -30 "24-30 Jul 2019" -20 "2-8 Oct 2019" -10 "11-17 Dec2019" 0 "19-25 Feb 2020" 10 "29 Apr-5 May 2020" 20 "9-15 Jul 2020" 30 "16-22 Sep 2020" 40 "25 Nov-1 Dec 2020" 50 60, labsize(tiny)) xline(-1, lcolor(black))  xsize(7) graphregion(color(white)) plotregion(color(white)) bgcolor(white) color(red)) coef_op(mcolor(edkblue) connect(l) lcolor(edkblue))

graph save "Graph" "C:\Users\enric\Desktop\RA\Event study 25 Febbraio urologia.gph"
